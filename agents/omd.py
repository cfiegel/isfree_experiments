...
class OMDBase(object):
  ...
  def __init__(
    ...
    self.eps = 1e-15 #for normalization to avoid zero division
    ...
    #Learning rate 
    self.base_learning_rate = lr_constant * base_constant

    #Implicit exploration
    self.base_implicit_exploration = ix_constant * base_constant
  ...
  def update_average_policy(self):
    ...
    ''' 
    self.average_policy.action_probability_array = (self.cumulative_plan+self.eps)*self.legal_actions_mask
